...
@cd Log
%SystemRoot%\Microsoft.NET\Framework\v4.0.30319\MSBuild.exe Log.sln /t:Rebuild /property:Configuration=Debug /l:FileLogger,Microsoft.Build.Engine;logfile=log4net.vs2010.log
@echo Close notepad to continue...
